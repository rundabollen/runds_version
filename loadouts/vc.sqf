/*
    ...
    id = ["TYPE", this] call compile preprocessFileLineNumbers "loadouts\vc.sqf";
*/
params ["_type", "_unit"];
    ...
    // Backpacks
private _backpack = selectRandom ["vn_o_pack_01", "vn_o_pack_04"];
};
    _medpack = _backpack;
    ...
    // Backpack radios
    _backradio = "vn_o_pack_t884_01";    // Little to no cargo space
...
private _vest = switch (_type) do {
    case "AR": {"vn_o_vest_vc_03"};	
    case "SL": {"vn_o_vest_vc_05"};
    case "GRENADIER": {"vn_o_vest_08"};
    case "CLS": {"vn_o_vest_vc_04"};
    default {selectRandom [
        "vn_o_vest_vc_02",
        "vn_o_vest_vc_01"
        ];};
